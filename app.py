...
st.markdown("""
    ...
    <div class="app-header">
        <img src="https://img.icons8.com/external-flat-juicy-fish/344/external-code-web-development-flat-flat-juicy-fish.png" class="logo" width="60"/>
...
user_prompt = st.text_area(
    ...
    placeholder=f"e.g. Create a login page using {language_name}"
)
